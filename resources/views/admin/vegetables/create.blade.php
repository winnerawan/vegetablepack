        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Tambah Sayur</h5>
                </div>
                <!-- Breadcrumb -->
                    ...
                    <div class="panel panel-default card-view">
                        <div class="panel-wrapper collapse in">
                            <div class="panel-body">
                                <div class="form-wrap">
                                    {!! Form::open(['route' => 'admin.vegetables.store', 'data-parsley-validate' => '', 'files' => true, 'method' => 'POST  ']) !!}
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-actions">
                                            ...
                                            {{ Form::submit('Buat', array('class' => 'btn btn-success left-icon mr-10 pull-left')) }}
                                            {{--<button class="btn btn-success btn-icon left-icon mr-10 pull-left"> <i class="fa fa-check"></i> <span>save</span></button>--}}
                                            <button type="button" class="btn btn-warning pull-left">Batal</button>
                                            <div class="clearfix"></div>
                                        </div>
                                    {!! Form::close() !!}
                                </div>
