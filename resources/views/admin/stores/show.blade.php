        ...
        <div class="container-fluid">
            ...
            <div class="row heading-bg">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Detail Toko</h5>
                </div>
                <!-- Breadcrumb -->
                                ...
                                <div class="row">
                                        ...
                                        <div class="item-big">
                                            ...
                                            <div id="carousel-example-captions-1" data-ride="carousel"
                                                ...
                                                <div role="listbox" class="carousel-inner">
                                                    <div class="item active"><img src="{{ asset('images/' . $store->image) }}"
                                    ...
                                    <div class="col-md-9">
                                        <div class="product-detail-wrap">
                                            ...
                                            {{--</div>--}}
                                            <h3 class="mb-20 weight-500">{{ $store->name }}</h3>
                                            <div class="product-price head-font mb-30">Pemilik Toko :  <a href="{{ url('admin/merchants/' . $store->merchant_id) }}"> {{ $store->merchant->name }}</a></div>
                                            <p class="mb-50">{{ $store->description }}.</p>
                                ...
                                <div class="tab-struct custom-tab-1 product-desc-tab">
                                    ...
                                    <div class="tab-content" id="myTabContent_7">
                                        <div id="descri_tab_detail" class="tab-pane fade active in pt-0"
                                             role="tabpanel">{{ $store->description }}</p>
                                        </div>
                                            ...
                                            <div class="table-wrap">
                                                <div class="table-responsive">
                                                    <table class="table  mb-0">
                                                        <tbody>
                                                        <tr>
                                                            <td class="border-none">WILAYAH</td>
                                                            <td class="border-none">{{ $store->village->district->zone->name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td class="border-none">LOKASI</td>
                                                            <td class="border-none">{{ $store->village->name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <td>ALAMAT</td>
                                                            <td>{{ $store->street . $store->rt . $store->rw }}</td>
                                                        </tr>
                                                        <tr>
                                                        <tr>
                                                        <td>KONTAK</td>
                                                        ...
                                                        <td>{{ $store->open . ' - ' . $store->close . ' WIB'}}</td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
