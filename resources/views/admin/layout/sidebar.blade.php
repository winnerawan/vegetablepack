...
<div class="fixed-sidebar-left">
    <ul id="nav" class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
            <a href="javascript:load('{{url('admin/merchants')}}')"><div class="pull-left"><i class="zmdi zmdi-store mr-20"></i><span class="right-nav-text">Toko Mitra</span></div><div class="clearfix"></div></a>
